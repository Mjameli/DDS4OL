...
#    print("the size of message to be sent is ", len(message))
    #sending the message
    conn.send(message)
...
embed = hub.KerasLayer(url, trainable=False, output_key = 'elmo')
#outputkey = 'elmo' for word embeddings
...
#    sess.run(tf.tables_initializer())
    ...
    conn, addr = s.accept()
    print('Word level ELMO server is running')
